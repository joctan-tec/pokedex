...
export function PokemonCard({
  ...
  return (
    <li
      ...
      className={`flex items-center ${selectedId !== pokemon.id ? "bg-[#480101]" : "bg-[#700808]"} w-full px-5 py-2 hover:bg-[#700808] transition-colors border border-[#700808] cursor-pointer`}
    >
      <Image
